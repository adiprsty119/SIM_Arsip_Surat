                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_array($query)) {
                                            echo "<tr>
                                                    ...
                                                    <td>" . htmlspecialchars($row['tempat_lahir'] ?? '', ENT_QUOTES, 'UTF-8'), htmlspecialchars($row['tanggal_lahir'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>
                                                    <td>" . htmlspecialchars($row['pangkat_golongan'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>
                                                    <td>" . htmlspecialchars($row['pangkat_tmt'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>
                                                    <td>" . htmlspecialchars($row['nama_jabatan_eselon'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>
                                                    <td>" . htmlspecialchars($row['jabatan_eselon_tmt'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>
                                                    <td>" . htmlspecialchars($row['bulan_masakerja'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>
                                                    <td>" . htmlspecialchars($row['tahun_masakerja'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>
                                                    <td>" . htmlspecialchars($row['nama_diklat'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>
                                                    <td>" . htmlspecialchars($row['bulan_diklat'] ?? '', ENT_QUOTES, 'UTF-8') . " - " . htmlspecialchars($row['tahun_diklat'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>
                                                    <td>" . htmlspecialchars($row['jumlah_jam_diklat'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>
                                                    <td>" . htmlspecialchars($row['usia'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>
                                                    <td>" . htmlspecialchars($row['jenis_kelamin'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>
                                                    <td>" . htmlspecialchars($row['agama'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>
                                                    <td>" . htmlspecialchars($row['asal'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>
                                                    <td>" . htmlspecialchars($row['tahun_masakerja'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>
                                                    <td>" . htmlspecialchars($row['tingkat_pendidikan_terakhir'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>
                                                    <td>" . htmlspecialchars($row['no_ijazah'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>
                                                    <td>" . htmlspecialchars($row['jurusan'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>
                                                    <td>" . htmlspecialchars($row['instansi_sekolah'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>
                                                    <td>" . htmlspecialchars($row['tahun_lulus_pendidikan'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>
                                                    <td>" . htmlspecialchars($row['karpeg'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>
                                                    <td>" . htmlspecialchars($row['kgb'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>
                                                </tr>";
                                            $no++;
                                        }
                                        ?>
